...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN','https://mafilestore-moviezareas.koyeb.app') else APP_NAME+'.herokuapp.com'
...
[Donate Now](p.satiz004@oksbi) (UPI Id)
"""
	LAZY_HOME_TEXT = """
